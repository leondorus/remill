...
class AndroidRemillContainer(context: Context) : RemillContainer {
    ...
    override val androidBluetoothWrapper: AndroidBluetoothWrapper? =
        context.getSystemService(BluetoothManager::class.java).let { manager ->
    ...
    init {
        ...
        val platformNotificationEditUseCase =
            PlatformNotificationEditUseCase(fullPlatformNotificationRepo)
        ...
        notifGroupEditUseCase =
            NotifGroupEditUseCase(fullNotifGroupRepo, platformNotificationEditUseCase)
        fullDrugIntoUseCase = FullDrugInfoUseCase(
            drugEditUseCase,
            drugGetUseCase,
            notifGroupEditUseCase,
            notifGroupGetUseCase,
            platformNotificationEditUseCase
        )
    }
}